...
struct ContentView: View {
    ...
    @State private var editingEntry: BrakewatchEntry?
...
enum EntryFormMode {
    case add
    case edit(BrakewatchEntry)
}

struct EntryFormView: View {
    let mode: EntryFormMode
    var onSave: (BrakewatchEntry) -> Void
        ...
        NavigationStack {
            ...
            .toolbar {
                ...
                ToolbarItem(placement: .confirmationAction) {
                    Button("Save") {
                        var entry: BrakewatchEntry
                        if case .edit(let existing) = mode {
                            entry = existing
                        } else {
                            entry = BrakewatchEntry(title: "")
                        }
